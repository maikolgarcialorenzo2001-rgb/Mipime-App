...
describe('main process', () => {
  ...
  describe('db IPC handlers (T3)', () => {
    ...
    it('INTEGRATION: real runMigrations a través del handler db:sql real completa V1→V18 en DB temp real (C1)', async () => {
      ...
      // transacciones: V1→V18 completan y schema_version queda en 18.
